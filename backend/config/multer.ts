...
//     cb(
//       null,
//       file.fieldname + "_" + Date.now() + path.extname(file.originalname) // Create a unique file name
//     );
//   },
// });
...
//   } else {
//     cb(new Error("Only images and PDF files are allowed!") as any, false); // Reject the file with an error
//   }
// };
